pipeline {
  ...
  stages {
    stage('CI Build and push snapshot') {
      ...
      steps {
        dir('/home/jenkins/go/src/github.com/stefanprodan/k8s-podinfo') {
          checkout scm
          sh "make VERSION=$PREVIEW_VERSION LINUX_ARCH=amd64 build"
    ...
    stage('Build Release') {
      ...
      steps {
        dir('/home/jenkins/go/src/github.com/stefanprodan/k8s-podinfo') {
          ...
          sh "make VERSION=`cat VERSION` LINUX_ARCH=amd64 build"
    ...
    stage('Promote to Environments') {
      ...
      steps {
        dir('/home/jenkins/go/src/github.com/stefanprodan/k8s-podinfo/charts/podinfo') {
